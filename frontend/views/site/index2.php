...
<div class="site-index">
   ...
   <!-- <div class="jumbotron">
    ...
    <div class="body-content">
        ...
        <div class="row" style="margin-left: 30%;margin-top: 5%;">
            <div class="span4">
          ...
          <div class="span4" style="margin-left: 25%;">
          
            <p><a style="float:left;width:20%;"class="btn btn-lg btn-success" href="http://localhost:8888/advanced/frontend/web/index.php?r=site%2Fdashboard">Dashboard</a></p>
